...
type BalanceResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Enought       bool                   `protobuf:"varint,1,opt,name=enought,proto3" json:"enought,omitempty"`
...
func (x *BalanceResponse) GetEnought() bool {
	if x != nil {
		return x.Enought
	}
	return false
...
const file_protobuf_wallet_proto_rawDesc = "" +
	...
	"\bwithdraw\x18\x02 \x01(\x01R\bwithdraw\"H\n" +
	"\x0fBalanceResponse\x12\x18\n" +
	"\aenought\x18\x01 \x01(\bR\aenought\x12\x1b\n" +
	...
	"\n" +
	"GetWallets\x12\x16.wallet.WalletsRequest\x1a\x17.wallet.WalletsResponseB\x1cZ\x1agithub.com/simplecoding/v1b\x06proto3"
